                ...
                <div class="col-md-12 form-group">
                    @if ($blog->blog_image)
                        <div style="height: 100px;width:100px">
                            <img style="height: 80px;width:80px" src="{{ asset('public/uploads/blog/' . $blog->blog_image) }}"
                                alt="">
                        </div>
                    @endif
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="wdinput">
                            ...
                            <input class="form-control" value="{{ $blog->meta_description }}" name="meta_description"
