                ...
                <div class="content-wrapper">
                    <div class="product-detail-main w-100">
                        <div class='content'>
                            ...
                            <form action="{{ route('saveproductgallery') }}" class="dropzone" id='fileupload'>
...
@section('admin-script')
    <script>
        function getImages() {
            ...
            $.ajax({
                url: "{{ route('getproductgalleryimage') }}",
                method: "POST",
                data: {
    ...
    <script>
        ...
        $(document).ready(function() {
            $(document).on("click", ".deleteProductGalleryImage", function(e) {
                if (confirm('Are you sure want to delete this?')) {
                    ...
                    $.ajax({
                        url: "{{ route('deleteproductgallery') }}",
                        method: "post",
                        data: {
                            "imageId": imageId,
                        },
