...
<html>
  <head>
    <title>Ready To Ship - Jewelary</title>
    <meta charset="utf-8">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Best Sales</li>
  </ol>
</nav>
    </section>
    ...
    <section class="product-list-sidebard my-3">
        ...
        <aside class="product-sidebar border">
         ...
         <button class="btn productclose" id="productmenuclose"><i class="fa-solid fa-xmark"></i></button>
        </div>
            
         <div class="product-sidebar-box">
            <div class="heading-section bg-color-dark-1 pt-2 pb-3 px-2">
             <h5 class="heading-1 mb-0">Frame Type</h5>
            </div>
            <div class="product-sidebar-list">
                <ul>
                    <li>
                        <label class="checkbox-custom">Full
                        <input type="checkbox" checked="checked">
                        <span class="checkmark"></span>
                        </label>
                    </li>
                    <li>
                        <label class="checkbox-custom">Rimless
                        <input type="checkbox">
                        <span class="checkmark"></span>
                        </label>
                    </li>
                    <li>
                        <label class="checkbox-custom">Semi-Rimless
                        <input type="checkbox">
                        <span class="checkmark"></span>
                        </label>
                    </li>
         ...
         <div class="product-sidebar-box">
            <div class="heading-section bg-color-dark-1 pt-2 pb-3 px-2">
             <h5 class="heading-1 mb-0">Brand</h5>
            </div>
            <div class="product-sidebar-list">
                <ul>
                    <li>
                        <label class="checkbox-custom">BAVICI
                        <input type="checkbox" checked="checked">
                        <span class="checkmark"></span>
                        </label>
                    </li>
                    <li>
                        <label class="checkbox-custom">EIGHT to Eighty
                        <input type="checkbox">
                        <span class="checkmark"></span>
                        </label>
                    </li>
                    <li>
                        <label class="checkbox-custom">Flexon
                        <input type="checkbox">
                        <span class="checkmark"></span>
                        </label>
                    </li>
         ...
         <div class="product-sidebar-box">
            ...
            <div class="product-sidebar-list pb-2">

    <div id="slider-range"></div>
    
  <div class="slider-labels d-flex">
    <div class="caption ml-2">
     <h6>Min: <span id="slider-range-value1"></span>
    </div>
    <div class="caption ml-auto mr-2">
      <h6>Max: <span id="slider-range-value2"></span></h6>
    </div>
  </div>
      ...
      <form>
        ...
        <input type="hidden" name="max-value" value="">
         ...
         <div class="product-sidebar-box">
            <div class="heading-section bg-color-dark-1 pt-2 pb-3 px-2">
             <h5 class="heading-1 mb-0">Discount</h5>
            </div>
            <div class="product-sidebar-list">
                <ul>
                    <li>
                        <label class="checkbox-custom"> Upto 5% 
                        <input type="checkbox" checked="checked">
                        <span class="checkmark"></span>
                        </label>
                    </li>
                    <li>
                        <label class="checkbox-custom"> 5% - 10%
                        <input type="checkbox">
                        <span class="checkmark"></span>
                        </label>
                    </li>
                    <li>
                        <label class="checkbox-custom"> 10% - 15%
                        <input type="checkbox">
                        <span class="checkmark"></span>
                        </label>
                    </li>
                    <li>
                        <label class="checkbox-custom"> 15% - 25%
                        <input type="checkbox">
                        <span class="checkmark"></span>
                        </label>
                    </li>
                    ...
                    <li>
                        <label class="checkbox-custom"> More than 25%
                        <input type="checkbox">
                        <span class="checkmark"></span>
                        </label>
                    </li>
        ...
        <div class="main-product-section position-relative">
            ...
            <div class="product-cart-view">
              ...
              <a href="#" class="btn add-to-cart"><i class="fa-light fa-cart-shopping"></i></a>
              <a href="product-details.php" class="btn view-more-product"><i class="fa-light fa-eye"></i></a>
            </div>
          </div>
            </div>
            ...
            <h5 class="product-reviews badge  mb-0"> 5 <i class="fa-solid fa-star"></i> </h5>
            <h6 class="ready-to-ship d-inline-block ml-2 mb-0"><i class="fa-light fa-truck"></i></h6>
...
<div class="product-box position-relative">
            ...
            <div class="product-cart-view-hover">
            <div class="product-cart-view">
              <button class="btn add-wishlist-btn"><i class="fa-light fa-heart"></i> </button>
              <a href="#" class="btn add-to-cart"><i class="fa-light fa-cart-shopping"></i></a>
              <a href="product-details.php" class="btn view-more-product"><i class="fa-light fa-eye"></i></a>
            </div>
          </div>
            ...
            <button class="btn productmenu d-lg-none d-xl-none d-inline-block" id="productmenu"><i class="fa-light fa-bars"></i></button>
        </div>    
    </div>
        </div>
    </section>
    ...
    var $li = $('.dropdownlist').click(function() {
    $li.removeClass('show');
    $(this).addClass('show');
    });
    </script>
