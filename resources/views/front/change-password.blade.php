...
<html>
  <head>
    <title>Change Password - Jewelary</title>
    <meta charset="utf-8">
                ...
                <div class="my-account-main-section">
                   <div class="my-account-box">
                    <div class="heading-section d-flex">
                       <h3 class="heading-1">Update Password</h3>
                      ...
                      <form>
                        <div class="row">
                          <div class="col-12">
                            ...
                            <input type="text" placeholder="Current Password" name="" class="form-control">
                            </div>
                          </div>

                          <div class="col-xl-6 col-lg-6 col-12">
                            <div class="wdinput form-group">
                            <input type="email" placeholder="Enter New Password" name="" class="form-control">
                            </div>
                          </div>

                          <div class="col-xl-6 col-lg-6 col-12">
                            <div class="wdinput form-group">
                            <input type="number" placeholder="Enter Confirm Password" name="" class="form-control">
                            </div>
                          </div>
                          ...
                          <div class="col-xl-4 col-lg-4 col-md-4  col-12">
                            <div class="wdinput form-group">
                            <button class="btn bg-color-dark-1">Update Password</button>
                            </div>
                          </div>
                        </div>
                      </form>
