...
<html>
  <head>
    <title>My Address - Food Delivery</title>
    <meta charset="utf-8">
                ...
                <div class="my-account-main-section">
                   <div class="my-account-box">
                    <div class="heading-section d-flex">
                       <h3 class="heading-1">Save Address</h3>
                       <button class="btn ml-auto" id="addaddress"><i class="fa-light fa-plus"></i> Add Address</button> 
                    </div>
                    <div class="address-form hidden">
                      <form>
                        <div class="row">
                          ...
                          <div class="col-xl-4 col-lg-4 col-md-4  col-12">
                            <div class="wdinput form-group">
                            <button class="btn bg-color-dark-1">Save Address</button>
                            </div>
                          </div>
                        </div>
                      </form>
                    </div>
                       <div class="save-address-list">
                         <div class="save-address-box border p-2 position-relative">
                           <h6>Anil Bhatt</h6>
                           <p class="mb-0">Manikpur, Thakurpara PO Ital Gacha 2 no Airport gate Thakur Para United Club, Kolkata West Bengal- 700079</p>
                           <button class="btn edit-address p-0"><i class="fa-light fa-pen-to-square"></i></button>
                         </div>
                         <div class="save-address-box border p-2 position-relative">
                           <h6>Anil Bhatt</h6>
                           <p class="mb-0">Manikpur, Thakurpara PO Ital Gacha 2 no Airport gate Thakur Para United Club, Kolkata West Bengal- 700079</p>
