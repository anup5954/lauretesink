            ...
            <div class="mainproduct-flex d-flex">
                @if ($products->count() > 0)
                    <aside class="product-sidebar border">
                        ...
                        {{-- <div class="product-sidebar-box">
                            <div class="heading-section bg-color-dark-1 pt-2 pb-3 px-2">
                                <h5 class="heading-1 mb-0">Design</h5>
                            </div>
                            <div class="product-sidebar-list">
                                <ul>
                                    <li>
                                        <label class="checkbox-custom"> Handmade
                                            <input type="checkbox" checked="checked">
                                            <span class="checkmark"></span>
                                        </label>
                                    </li>
                                    <li>
                                        <label class="checkbox-custom"> Machinemade
                                            <input type="checkbox">
                                            <span class="checkmark"></span>
                                        </label>
                                    </li>
                        ...
                        {{-- <div class="product-sidebar-box">
                            <div class="heading-section bg-color-dark-1 pt-2 pb-3 px-2">
                                <h5 class="heading-1 mb-0">Grade</h5>
                            </div>
                            <div class="product-sidebar-list">
                                <ul>
                                    <li>
                                        <label class="checkbox-custom"> AISI-316
                                            <input type="checkbox" checked="checked">
                                            <span class="checkmark"></span>
                                        </label>
                                    </li>
                                    <li>
                                        <label class="checkbox-custom"> AISI-304
                                            <input type="checkbox">
                                            <span class="checkmark"></span>
                                        </label>
                                    </li>
                ...
                <div class="main-product-section position-relative">
                            ...
                            @foreach ($products as $product)
                                <div class="product-box position-relative" id="{{ $product->id }}">
                                    ...
                                    <div class="product-review-discount">
                                        {{-- <h5 class="product-reviews badge  mr-2"> 304 </h5>
                                        <h5 class="product-reviews badge "> Handmade </h5> --}}
                    ...
                    @if ($products->count() <= 0)
                        <div class="alert alert-success alert-dismissible">
                            ...
                            <strong>No product found for this category.</strong>
                        </div>
                    @endif
