<footer>
    ...
    <div class="main-footer bg-color-dark-2 pt-5">
        ...
        <div class="container-fluid">
            ...
            <div class="mobile-footer d-xl-none d-lg-none d-block">

                <div id="mainmobilefooter">



                    <div class="accordion" id="mobilefooter">

                        <div class="card">

                            <div class="card-header" id="mobilefooter1">

                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse"
                                    data-target="#mbfooter1" aria-expanded="false" aria-controls="mbfooter1">Qucik
                                    Links</a>
                            ...
                            <div id="mbfooter1" class="collapse " aria-labelledby="mobilefooter11"
                                data-parent="#mobilefooter">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header" id="mobilefooter2">

                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse"
                                    data-target="#mbfooter2" aria-expanded="true" aria-controls="faq2">Policy</a>

                            </div>



                            <div id="mbfooter2" class="collapse" aria-labelledby="mobilefooter2"
                                data-parent="#mobilefooter">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header" id="mobilefooter3">

                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse"
                                    data-target="#mbfooter3" aria-expanded="true" aria-controls="mbfooter3">Help</a>

                            </div>



                            <div id="mbfooter3" class="collapse" aria-labelledby="mobilefooter3"
                                data-parent="#mobilefooter">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-12">
                    ...
                    <div class="footer-link">
                        ...
                        <ul>
                            ...
                            <li> <i class="fa-light fa-phone"></i> +91 987 654 3210</li>

                            <li><i class="fa-light fa-envelope"></i> info@argindia.com</li>
            ...
            <div class="container">
                ...
                <div class="copyright d-flex">
                    ...
                    <div class="copyright-left">
                        ...
                        <p>Copyright ©️ 2022 ARG INDIA. All Rights Reserved.</p>
                    ...
                    <div class="copyright-right ml-auto">
                        ...
                        <ul class="payment-option ml-auto">
                            ...
                            <li>
                                ...
                                <img src="{{ asset('public/frontend/img/payment/paytm.svg') }}"
